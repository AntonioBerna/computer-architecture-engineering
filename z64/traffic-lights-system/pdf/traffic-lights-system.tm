...
<\body>
  ...
  The <shell|BUTTON> device is represented as a classic
  ...
  operates in mixed mode, i.e. both synchronously and asynchronously:
...
<\auxiliary>
  <\collection>
    <\associate|figure>
      ...
      LIGHT> peripheral>|<pageref|auto-5>>
